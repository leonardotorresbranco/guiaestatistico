...
with open('qbank.qbank_prebuilt_tests.json', 'r', encoding='utf-8') as f:
    data = json.load(f)


# Separar arrays de tags e parentTags
tags_data = data[0]['tags']
parent_tags_data = data[0]['parentTags']
...
#with open('hierarchical_data.json', 'w') as f:
